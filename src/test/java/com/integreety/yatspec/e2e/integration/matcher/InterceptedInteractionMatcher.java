...
public class InterceptedInteractionMatcher extends TypeSafeMatcher<InterceptedInteraction> {
    ...
    public static InterceptedInteractionMatcher with(final Type type, final String serviceName, final String body, final String target) {
        return new InterceptedInteractionMatcher(type, serviceName, body, target);
    }
}
