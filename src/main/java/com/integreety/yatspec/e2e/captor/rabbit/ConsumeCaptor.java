...
public class ConsumeCaptor {
    ...
    public void captureConsumeInteraction(final String exchange, final Message message) {
        final MessageProperties messageProperties = message.getMessageProperties();
        final Map<String, Collection<String>> headers = headerRetriever.retrieve(messageProperties);
        final String interactionName = consumeOf(exchange, sourceNameMappings.mapForPath(NO_PATH));
