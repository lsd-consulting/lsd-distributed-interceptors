...
import static com.integreety.yatspec.e2e.captor.repository.Type.PUBLISH;
...
public class PublishCaptor {
    ...
    public void capturePublishInteraction(final Message message) {
        ...
        final Map<String, Object> data = mapGenerator.generateFrom(new String(message.getBody()), headers, interactionName, PUBLISH);
