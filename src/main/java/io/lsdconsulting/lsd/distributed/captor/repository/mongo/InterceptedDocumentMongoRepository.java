package io.lsdconsulting.lsd.distributed.captor.repository.mongo;
...
import io.lsdconsulting.lsd.distributed.captor.repository.mongo.codec.ZonedDateTimeCodec;
...
public class InterceptedDocumentMongoRepository implements InterceptedDocumentRepository {
    ...
    public static final CodecRegistry pojoCodecRegistry = fromRegistries(getDefaultCodecRegistry(), CodecRegistries.fromCodecs(new ZonedDateTimeCodec()),
